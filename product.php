...
<head>
    <link rel="stylesheet" href="/fkart/assets/css/style.css">
    <script src="/fkart/assets/js/min.js"></script>
...
<div id="container" style="overflow:hidden">
    <div style="height:100%" data-reactroot="">
            ...
            <div class="_38U37R">
                <div class="_1FWdmb">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="Z4_K_h" href="/" style="margin: 0 10px;">
                            <img class="logop" src="/fkart/assets/images/img/favicon.png" style="width:25px;">
                        </a>
                    </div>
                    <div class="header-menu">
                        <a class="_3NH1qf" href="/fkart/cart.php">
                            <img src="/fkart/assets/images/svg/cart.svg" alt="">
        ...
        <body class="expansion-alids-init" cz-shortcut-listen="true">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    window.addEventListener('scroll', function () {
                        ...
                        // If it's the first scroll, we let the header scroll with the page
                        if (isFirstScroll) {
                            header.style.top = '0'; // Keep the header at the top initially
                            isFirstScroll = false; // After first scroll, change behavior
                        } else {
                            // User is scrolling down
                            if (currentScroll > lastScrollTop && currentScroll > headerHeight) {
                                // Only hide the header after scrolling past its height
            ...
            <div class="space" style="height: 56px;"></div>
            ...
            <div class='carousel-item active'>
                <img class='d-block w-100 product_img active' src='{$product_image}' alt='Custom Image' draggable='false'>
            </div>";
                    ...
                    <div class='carousel-item'>
                        <img class='d-block w-100' src='{$url}' alt='Slide'draggable='false'>
                    </div>";
                                }
                            }
                            ?>
            ...
            <div class="order-info">
                <div>
                    <img src="https://rukminim2.flixcart.com/www/48/48/promos/15/07/2021/e2ee7c1c-ec9e-4ae7-b5dd-6b2685299686.jpg"
                        alt="Increase Icon">
                </div>
            ...
            <div class="d-margin">
                <div class="container-fluid p-0">
                    ...
                    ?>
                    <p class="company-name"><?php echo $company_name; ?>
                        <span class="product-title" id="product-title"><?php

                        // Truncate product name to 70 characters for display
                        $maxLength = 100;
                        $productNameDisplay = (strlen($product_name) > $maxLength) ? substr($product_name, 0, $maxLength) . '... <a href="javascript:void(0);" onclick="showFullName()" class="no-underline">more</a>' : $product_name;
                        echo $productNameDisplay;
                        ?>
                        </span>

                        <script>
                            // This function will update the product title to the full name when 'more' is clicked.
                            function showFullName() {
                                var fullName = "<?php echo addslashes($product_name); ?>"; // Get the full product name from PHP
                                var productTitle = document.getElementById('product-title');

                                productTitle.innerHTML = fullName; // Replace the truncated text with the full name
                            }
                        </script>


                    <div class="rating-area">
                        <div class="rating-img"><img src="/fkart/assets/images/svg/<?php echo $rating; ?>" alt="rating">
                        </div>
                        ...
                        <div class="f-assured">
                            <div><img src="/fkart/assets/images/img/assured_new.png" alt="F-Assured"></div>
                        </div>
                    </div>
            ...
            if ($category == "mobiles") {
                ...
                <div class="all-offers" style="margin: -10px -4px;">
                    ...
                    <div class="ao-img"><img src="/fkart/assets/images/img/next-arrow.png" alt=""></div>
                </div>
                <div class="space" style="height: 1px;"></div>
                ...
                <div class="cl-box">
                    ...
                    <div class="cl-size-chart-icon">
                        <div class="cl-size-svg">
                            <img src="/fkart/assets/images/svg/size-chart.svg" alt="Size Chart">
                            <p>Size Chart</p>
                        </div>
                    </div>
            ...
            <div class="term-box">
                <div class="term-item">
                    <div class="term-box-img">
                        <img src="/fkart/assets/images/img/terms1.png" alt="">
                    </div>
                    <div class="term-box-text">7 Days Service Center Replacement/Repair</div>
                </div>
                <div class="term-item">
                    <div class="term-box-img">
                        <img src="/fkart/assets/images/img/terms2.png" alt="">
                    </div>
                    <div class="term-box-text">No Cash On Delivery</div>
                </div>
                <div class="term-item">
                    <div class="term-box-img">
                        <img src="/fkart/assets/images/img/terms3.png" alt="">
                    </div>
            ...
            <p style="display:none" id="product-url"><?php echo htmlspecialchars($product_url); ?></p>
            <?php
            $reviewPhrases = [
                'Supper',
                'Brilliant',
            ...
            for ($i = 0; $i < 10; $i++) {
                ...
                <div class="review-section">
                    <div class="rating">
                        <span><img src="/fkart/assets/images/svg/<?php echo $rating; ?>" alt=""></span>
                    ...
                    <?php if ($category == 'mobiles'): ?>
                        <div class="review-details">
                            <p>Review for: Color <?php echo htmlspecialchars($color_name); ?> · RAM
                                <?php echo htmlspecialchars($ram); ?> · Storage
                                <?php echo htmlspecialchars($storage); ?>
                            </p>
                        </div>
                    <?php elseif ($category == 'footware'): ?>
                        <div class="review-details">
                            <p>Review for: Color <?php echo htmlspecialchars($color_name); ?> · Size:
                                <?php echo htmlspecialchars($uksize); ?>
                            </p>
                        </div>
                    ...
                    <div class="action-box">
                        <div class="actions">
                            <div>
                                <img src="/fkart/assets/images/svg/like.svg" alt="">
                                Helpful for <?php echo rand(1, 1500); ?>
                            </div>
                            <div>
                                <img src="/fkart/assets/images/svg/dislike.svg" alt="">
                                <?php echo rand(1, 800); ?>
                            </div>
                        </div>
                    ...
                    <div class="verified">
                        <img src="/fkart/assets/images/svg/verified.svg" alt="">
    ...
    <div class="category" style="display: none"><?php echo htmlspecialchars($category); ?></div>
    <br><br><br>
    ...
    <script type="text/javascript">
        ...
        // Store the product URL in local storage when the page loads
        document.addEventListener("DOMContentLoaded", function () {
            var productUrl = document.getElementById('product-url').innerText;
            localStorage.setItem('productUrl', productUrl);
            console.log("Stored product URL:", productUrl); // Check if it's stored correctly
        });

        // Function to add to cart
        function add_to_cart(CartEvent = "") {
            console.log("Add to Cart function triggered");
            ...
            // Get the product URL from local storage
            const product_url = localStorage.getItem('productUrl');
            console.log("Retrieved product URL in add_to_cart:", product_url); // Check the retrieved URL
            ...
            const product_img = $('.main_image').attr('src');
            const color = $('.color-item.active').find('span').text().trim();
            const storage = $('.dress-size.active').text();
            const category = $('.category').text().trim();

            // Capture rating details
            const rating_img_url = $('.rating-img img').attr('src');  // Get rating image URL
            const rating_img = rating_img_url.split('/').pop();  // Extract filename (e.g., rating4.svg)
            const rating_point = parseFloat($('.rating-point').text().trim());  // Get rating point
            const total_rating = parseInt($('.total-rating-num').text().trim().split(' ')[0]);  // Extract total ratings

            // Capture delivery message or formatted delivery date
            let delivery_message = $('.delivery-date p').text().trim();  // Get the full delivery message text
            let formatted_delivery_date = "";

            // Check if the delivery message includes days
            const regex = /\bby (\d+) days\b/;
            const matches = regex.exec(delivery_message);
            if (matches && matches[1]) {
                const days = parseInt(matches[1]);
                const currentDate = new Date();
                currentDate.setDate(currentDate.getDate() + days);
                formatted_delivery_date = currentDate.toLocaleDateString("en-IN", { day: 'numeric', month: 'short', weekday: 'long' });
                delivery_message = `Free delivery by ${formatted_delivery_date}`;  // Update the message to include the calculated date
            }

            console.log("Product details:", { product_id, product_title, color, storage, category, rating_img, rating_point, total_rating, delivery_message });
            ...
            if (products.length > 0) {
                for (let index = 0; index < products.length; index++) {
                    if (products[index]['product_id'] === product_id &&
                        ...
                        products[index]['product_title'] === product_title) {
                        // If product exists with identical details, increase quantity
            ...
            if (!is_added_product) {
                products.push({
                    ...
                    'delivery_message': delivery_message,  // Store the delivery message or date
                    'mrp': mrp_price,
                    'price': price,
                    'qty': 1,
                    'product_url': product_url // Add the product URL here
                });
            }
            ...
            // Show loading animation and text "Adding"
            const button = $('.add_cart');
            button.prop('disabled', true); // Disable button to prevent multiple clicks
            button.find('.button-text').hide(); // Hide "Add to Cart" text
            button.find('.loading-spinner').show(); // Show loading spinner and "Adding" text

            // After 1.5 seconds, change the text to "Added"
            setTimeout(function () {
                button.find('.loading-spinner').hide(); // Hide the loading spinner
                button.find('.button-text').text('Added').show(); // Show "Added" text
            }, 1500);

            // After 2 seconds, reset the button to its default state
            setTimeout(function () {
                button.find('.button-text').text('Add to Cart'); // Reset button text to default
            ...
            // Fetch product URL from the page
            const productUrl = document.getElementById('product-url').textContent.trim(); // or use `.value` for hidden input

            // Redirect logic
            if (CartEvent === "buyNow") {
                window.location.href = `${BASEURL}/fkart/payment.php?product_url=${encodeURIComponent(productUrl)}`;
            }
...
<script src="/fkart/assets/js/bootstrap.min.js"></script>
